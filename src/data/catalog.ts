...
export const fragancias: Fragancia[] = [
  { id: "f-1", slug: "orange-blossom-bergamot", nombre: "Orange Blossom & Bergamot", familia: "Floral cítrico", coleccion: "orchard", descripcion: "Como abrir una ventana en marzo: azahar, cáscara y luz.", salida: "Bergamota, mandarina", corazon: "Azahar, neroli", fondo: "Almizcle blanco", usos: "Velas · Room spray · Perfume", tamanos: tamanosBase, acento: "tomate" },
  { id: "f-2", slug: "marshmallow-cake", nombre: "Marshmallow Cake", familia: "Gourmand", coleccion: "pantry", descripcion: "Azúcar quemada y masa tibia. Peligrosamente comestible.", salida: "Azúcar, coco", corazon: "Marshmallow, bizcocho", fondo: "Vainilla, tonka", usos: "Velas · Wax melts · Jabones", tamanos: tamanosBase, acento: "rosa" },
  { id: "f-3", slug: "agave-aloe", nombre: "Agave Aloe", familia: "Verde fresco", coleccion: "garden", descripcion: "Verde jugoso, casi mineral. Huele a estar limpio sin ser detergente.", salida: "Aloe, pepino", corazon: "Agave, hoja verde", fondo: "Ámbar suave", usos: "Velas · Body · Jabones", tamanos: tamanosBase, acento: "chartreuse" },
  { id: "f-4", slug: "vanilla-coconut", nombre: "Vanilla Coconut", familia: "Gourmand cremoso", coleccion: "pantry", descripcion: "Playa, bronceador y postre. Todo a la vez.", salida: "Coco", corazon: "Leche de coco", fondo: "Vainilla, sándalo", usos: "Velas · Body · Aceites", tamanos: tamanosBase, acento: "rosa" },
  { id: "f-5", slug: "fig-black-currant", nombre: "Fig & Black Currant", familia: "Frutal verde", coleccion: "orchard", descripcion: "Higo lechoso con un mordisco ácido de grosella.", salida: "Grosella negra", corazon: "Higo, hoja de higuera", fondo: "Cedro, musgo", usos: "Velas · Room spray", tamanos: tamanosBase, acento: "cobalto" },
  { id: "f-6", slug: "rose-mint", nombre: "Rose Mint", familia: "Floral fresco", coleccion: "garden", descripcion: "Rosa despierta, con menta que le quita lo cursi.", salida: "Menta, eucalipto", corazon: "Rosa, geranio", fondo: "Almizcle", usos: "Velas · Jabones · Body", tamanos: tamanosBase, acento: "rosa" },
  { id: "f-7", slug: "pear-weeping-cypress", nombre: "Pear & Weeping Cypress", familia: "Frutal maderoso", coleccion: "woods", descripcion: "Pera crujiente sobre madera húmeda. Rara y elegante.", salida: "Pera, manzana verde", corazon: "Ciprés, salvia", fondo: "Vetiver", usos: "Velas · Difusores", tamanos: tamanosBase, acento: "ink" },
  { id: "f-8", slug: "holly", nombre: "Holly", familia: "Especiado verde", coleccion: "woods", descripcion: "Acebo, pino y una especia que aparece al final.", salida: "Pino, cítrico", corazon: "Acebo, clavo", fondo: "Bálsamo", usos: "Velas · Temporada", tamanos: tamanosBase, acento: "chartreuse" },
  { id: "f-9", slug: "pumpkin-maple-sugar", nombre: "Pumpkin Maple Sugar", familia: "Gourmand especiado", coleccion: "pantry", descripcion: "El otoño que en el Caribe solo existe en velas.", salida: "Maple, canela", corazon: "Calabaza, nuez moscada", fondo: "Azúcar morena", usos: "Velas · Wax melts", tamanos: tamanosBase, acento: "tomate" },
  { id: "f-10", slug: "verbena-bamboo", nombre: "Verbena Bamboo", familia: "Cítrico verde", coleccion: "coast", descripcion: "Limpio, fresco, con bambú acuoso detrás.", salida: "Verbena, limón", corazon: "Bambú, té verde", fondo: "Musgo blanco", usos: "Velas · Room spray · Jabones", tamanos: tamanosBase, acento: "cobalto" },
  { id: "f-11", slug: "bluebell", nombre: "Bluebell", familia: "Floral verde", coleccion: "strange", descripcion: "Campanilla azul: floral con un giro ligeramente extraño y precioso.", salida: "Hoja verde", corazon: "Campanilla, jacinto", fondo: "Almizcle, madera clara", usos: "Velas · Perfume", tamanos: tamanosBase, acento: "cobalto" },
];
